...
namespace E_Learning.DAL.Migrations
{
    ...
    [Migration("20240213154657_gradesandplace")]
    partial class gradesandplace
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Learning.DAL.Models.OfflineLecture", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PlaceTimeId");

                    b.HasIndex("QuizeId");

                    b.HasIndex("UserId");

                    b.ToTable("OfflineLectures");
                });
            ...
            modelBuilder.Entity("E_Learning.DAL.Videofiles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Learning.DAL.User", b =>
                {
                    ...
                    b.HasIndex("PlaceWithTimeId")
                        .IsUnique()
                        .HasFilter("[PlaceWithTimeId] IS NOT NULL");
            ...
            modelBuilder.Entity("E_Learning.DAL.User", b =>
                {
                    ...
                    b.HasOne("E_Learning.DAL.Models.PlaceWithTime", "PlaceWithTime")
                        .WithOne("User")
                        .HasForeignKey("E_Learning.DAL.User", "PlaceWithTimeId");
